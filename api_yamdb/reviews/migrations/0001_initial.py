# Generated by Django 2.2.16 on 2022-10-14 15:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='title',
            name='genre',
            field=models.ManyToManyField(related_name='title', through='reviews.TitleGenreAssign', to='reviews.Genre'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('text', models.TextField(help_text='Напишите ваш отзыв', max_length=100, verbose_name='review')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to=settings.AUTH_USER_MODEL, verbose_name='review`s author')),
